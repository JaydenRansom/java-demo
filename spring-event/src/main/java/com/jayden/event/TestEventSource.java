 ...
 */
@Component
public class TestEventSource implements ApplicationEventPublisherAware {

    private static final Logger logger = LoggerFactory.getLogger(TestEventSource.class);
